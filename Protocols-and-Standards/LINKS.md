# Protocol and Standard Repository Links

These repositories establish procedures, handling rules, standards, or repeatable operating requirements used in AI Foundations.
...
- [functional-source-line-requirement](https://github.com/alyssadata/functional-source-line-requirement) — Functional requirement for source-line preservation.
- [scope-collision-gate](https://github.com/alyssadata/scope-collision-gate) — Gate for handling scope collisions.

Repositories can be cross-listed here when they function as an operational standard even if they also belong in Governance or Evaluations.
